...
function createMappingIfNotPresent (options, cb) {
  ...
  generator.generateMapping(schema, (ignoredErr, mapping) => {
    ...
    client.indices.exists({
      ...
      if (err) {
        console.log("client.indices.exists err")
        console.log(err)
        return cb(err)
      }

      if (exists) {
        console.log("client.indices.exists putMapping " + indexName)
        console.log(JSON.stringify(completeMapping))
      ...
      return client.indices.create({
        ...
        if (indexErr) {
          console.log("client.indices.create err")
          console.log(err)
          return cb(indexErr)
        }
